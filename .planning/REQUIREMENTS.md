...
- [x] **DOCS-03**: API reference documenting all HTML attributes and CSS custom properties
- [x] **DOCS-04**: Theming guide with examples for customizing colors, position, and size
